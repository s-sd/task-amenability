...
class MetaRL0(gym.Env):
    def __init__(self):
        ...
        holdout_labels_loaded = np.load(os.path.join(save_path, 'test', 'qy_seg.npy'))
        ...
        val_labels_loaded = np.load(os.path.join(save_path, 'val', 'qy_seg.npy'))     
        train_imgs_loaded = np.load(os.path.join(save_path, 'train', 'imgs.npy'))
        train_labels_loaded = np.load(os.path.join(save_path, 'train', 'qy_seg.npy'))

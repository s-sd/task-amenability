...
class MetaRL2(gym.Env):
    def __init__(self):
        ...
        holdout_labels_loaded = np.load(os.path.join(save_path, 'test', 'zb_seg.npy'))
        ...
        val_labels_loaded = np.load(os.path.join(save_path, 'val', 'zb_seg.npy'))     
        train_imgs_loaded = np.load(os.path.join(save_path, 'train', 'imgs.npy'))
        train_labels_loaded = np.load(os.path.join(save_path, 'train', 'zb_seg.npy'))
